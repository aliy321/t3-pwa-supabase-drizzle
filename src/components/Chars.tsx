	...
	return (
		<div className="chart-wrapper mx-auto flex max-w-6xl flex-col flex-wrap items-start justify-center gap-6 p-6 sm:flex-row sm:p-8">
			<div className="grid w-full gap-6 sm:grid-cols-2 lg:max-w-[22rem] lg:grid-cols-1 xl:max-w-[25rem]">
				...
				>
					<TextureCardHeader className="space-y-0 pb-2">
						<TextureCardDescription>Today</TextureCardDescription>
						<TextureCardTitle className="text-4xl tabular-nums">
							12,584{' '}
					...
					<TextureCardFooter className="flex-col items-start gap-1">
						<CardDescription>
